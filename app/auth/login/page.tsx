    ...
    <div className="min-h-screen bg-[#FFF8EC] flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-[#013C5A]/10">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl text-[#013C5A]">Welcome Back</CardTitle>
          <CardDescription>Sign in to your KeyNest account</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <Link href="/auth/forgot-password" className="text-sm text-[#013C5A] hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#013C5A]/70">
              ...
              <Link href="/auth/signup" className="text-[#013C5A] hover:underline font-medium">
                Sign up
              </Link>
            </p>
          </div>
