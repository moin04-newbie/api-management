...
import { Target, Users, Key, TrendingUp, Activity, Clock, IndianRupee, GitBranch, LogIn, BarChart3, Shield, AlertTriangle } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const fallbackWorkspace = currentWorkspace || { name: 'KeyNest Main' }
